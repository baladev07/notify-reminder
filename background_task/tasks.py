...
from notify.models import reminderdetails
...
def bg_runner(proxy_task, task=None, *args, **kwargs):
    ...
    try:
        ...
        if task:
            ...
            updateReminderStatus(completed.task_created_time)
...
def updateReminderStatus(created_time):
    reminder_object = reminderdetails.objects.get(created_time=created_time)
    reminder_object.reminderStatus = 'completed'

...
class TaskManager(models.Manager):
    ...
    def new_task(self, task_name, args=None, kwargs=None,
                 ...
                 remove_existing_tasks=False, user_name=None, created_time=None, updated_time=None):
        """
...
class Task(models.Model):
    ...
    updatedTime = models.BigIntegerField(null=True, blank=True)
    createdTime = models.BigIntegerField(null=True, blank=True)
    ...
    def create_completed_task(self):
        ...
        completed_task = CompletedTask(
            ...
            task_created_time=self.createdTime
        )
        completed_task.save()
...
class CompletedTask(models.Model):
    ...
    task_created_time = models.BigIntegerField(null=True, blank=True)
